...
const ADDRESS = '0x9cbe5c98c1c7769ebff72d479c52a3f08336ee53';
const OBJECT_ID = '0xe76fdca766fb603f3188ab88f0a9b4b799d54c37';
const MNEMONIC = 'galaxy buyer grab update result comfort example budget word frog teach mask'
test("vault", async () => {
...
test('Transaction tests', async () => {
    ...
    // await provider.transferCoin('SUI', BigInt(333), ADDRESS, vault);
    ...
    console.log("target balance", Array.from(result.entries()).map((item) => ({
