...
export default class ReactNativeStorage implements Storage {
  async getWallets(): Promise<Wallet[]> {
    ...
    try {
      ...
      console.log('getWallets', Date.now() - t);
    }
  }
  ...
  async getWallet(id: string): Promise<Wallet> {
    ...
    try {
      ...
      console.log('getWallet', Date.now() - t);
    }
  }
  ...
  async addWallet(id: string, wallet: Wallet): Promise<void> {
    ...
    try {
      ...
      console.log('addWallet', Date.now() - t);
    }
  }
  ...
  async loadMeta(): Promise<any> {
    ...
    try {
      ...
      console.log('loadMeta', Date.now() - t);
    }
  }
  ...
  async saveMeta(meta: any): Promise<void> {
    ...
    try {
      ...
      console.log('saveMeta', Date.now() - t);
    }
  }
  ...
  async updateMetaAndWallets(meta: any, wallets: Wallet[]) {}
}
