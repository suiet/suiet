  ...
  constructor() {
    ...
    Tt(this, kr, async (i) => {
      ...
      if (St(this, Wt) === "disconnected") {
        ...
        try {
          await tr(this, fr, Fr).call(this, "dapp.connect", {
      ...
      return St(this, Yt) && St(this, Yt).address === s.address ? { accounts: this.accounts } : (Gt(this, Yt, new Re({
        address: s.address,
    ...
    Gt(this, Kt, eo()), Gt(this, yr, new fi(
      mr.DAPP,
      mr.SUIET_CONTENT
    ));
  }
